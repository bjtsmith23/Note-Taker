...
[![License Badge](https://img.shields.io/static/v1?label=License&message=Apache&color=green&?style=plastic&link=https://choosealicense.com/licenses/apache-2.0/)](https://choosealicense.com/licenses/apache-2.0/)
  ...
  ## Description
  Allow user to create new notes and store them on side of page - but also have the option to delete notes. Adding and deleting notes is done through the backend.
  ...
  ## Usage
  To record notes or todo's to help keep organized.
  ...
  ![Screenshot of Note Taker](/images/screenshot.png)
